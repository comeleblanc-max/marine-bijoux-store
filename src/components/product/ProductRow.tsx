          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2">
              <button
                ...
                className="w-9 h-9 border border-[#E8E2D5] flex items-center justify-center hover:bg-[#0E4F5E] hover:text-white hover:border-[#0E4F5E] transition-colors disabled:opacity-30 disabled:hover:bg-transparent disabled:hover:text-[#0E4F5E] disabled:hover:border-[#E8E2D5]"
              >
