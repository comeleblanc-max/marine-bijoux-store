      ...
      <div className="container-x">
        ...
        <div className="flex items-end justify-between mb-8 sm:mb-10">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl text-[#1F3A56]">
              {title}
            </h2>
          </motion.div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2">
              <button
                ...
                className="w-9 h-9 border border-[#E8E2D5] flex items-center justify-center hover:bg-[#1F3A56] hover:text-white hover:border-[#1F3A56] transition-colors disabled:opacity-30 disabled:hover:bg-transparent disabled:hover:text-[#1F3A56] disabled:hover:border-[#E8E2D5]"
              >
