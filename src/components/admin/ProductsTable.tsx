            ...
            {filtered.length === 0 ? (
              ...
              filtered.map((p) => (
                <tr key={p.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className="text-sm font-semibold text-[#1F3A56]">{p.price.toFixed(2)} €</span>
                    {p.compareAt && (
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2 justify-end">
                      <Link
                        ...
                        className="p-1.5 rounded-lg hover:bg-gray-100 text-gray-400 hover:text-[#1F3A56] transition-colors"
                        title="Modifier"
                      >
