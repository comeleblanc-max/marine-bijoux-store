    ...
    <section className="py-16 sm:py-24 bg-white">
      <div className="container-x">
        <Reveal className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl text-[#24BBD0]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto">
          {TESTIMONIALS.map((t, i) => (
            ...
            >
              ...
              <p className="text-[#24BBD0] leading-relaxed text-sm mb-6 italic">
                "{t.comment}"
              </p>
              <div className="border-t border-[#E8E2D5] pt-4">
                <p className="text-sm font-medium text-[#24BBD0]">{t.name}</p>
