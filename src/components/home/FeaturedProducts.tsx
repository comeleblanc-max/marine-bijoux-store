...
export function FeaturedProducts() {
  ...
  return (
    <>
      {/* ── Meilleures ventes ── */}
      <section className="py-16 sm:py-24 px-4 bg-[#F5E9D6]/50">
        <div className="max-w-7xl mx-auto">
          <Reveal className="flex items-end justify-between mb-10">
            ...
            <Link
              ...
              className="hidden sm:inline text-sm text-[#1F3A56]/60 hover:text-[#D4AF37] transition-colors underline-offset-4 hover:underline"
            >
              Voir tout →
            </Link>
          </Reveal>
          ...
          <Reveal delay={0.15} className="text-center mt-8 sm:hidden">
            <Link
              href="/collections/all"
              className="text-sm text-[#1F3A56]/60 hover:text-[#D4AF37] transition-colors underline-offset-4 underline"
            >
        ...
        <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-center gap-8 sm:gap-16 text-center">
          {[
            ...
            <div key={label} className="flex flex-col items-center gap-1">
              ...
              <p className="text-xs font-semibold text-[#1F3A56]">{label}</p>
