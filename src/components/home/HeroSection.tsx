        ...
        >
          <Link href="/collections/lumiere-dete">
            <motion.span
              ...
              className="inline-flex bg-[#0E4F5E] hover:bg-[#D4AF37] text-white px-10 py-4 rounded-full font-semibold tracking-wide shadow-xl shadow-[#0E4F5E]/20 text-base transition-colors"
            >
