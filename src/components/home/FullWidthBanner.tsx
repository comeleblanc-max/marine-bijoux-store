        ...
        >
          ...
          <Link href="/pages/a-propos">
            <motion.span
              ...
              whileTap={{ scale: 0.97 }}
              transition={{ type: 'spring', stiffness: 400, damping: 17 }}
              className="inline-flex border border-white/80 text-white hover:bg-white hover:text-[#1A1A1A] px-9 py-4 rounded-full font-medium tracking-wide text-sm sm:text-base transition-colors backdrop-blur-sm"
            >
              Notre histoire
            </motion.span>
          </Link>
