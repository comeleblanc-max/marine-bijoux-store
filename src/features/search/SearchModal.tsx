          ...
          >
            ...
            <div className="flex items-center gap-3 px-5 py-4 border-b border-gray-100">
              ...
              <input
                ...
                className="flex-1 text-base outline-none text-[#24BBD0] placeholder:text-gray-400"
              />
              {query && (
                    ...
                    <li key={product.id}>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-medium text-[#24BBD0] group-hover:text-[#D4AF37] transition-colors text-sm">{product.name}</p>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Colliers', 'Bracelets', "Boucles d'oreilles", 'Bagues'].map(cat => (
                      <Link
                        ...
                        onClick={onClose}
                        className={cn(
                          'px-3 py-1.5 rounded-full bg-[#FAF5EA] text-sm text-[#24BBD0] hover:bg-[#D4AF37] hover:text-white transition-colors'
                        )}
                      >
                        {cat}
                      </Link>
