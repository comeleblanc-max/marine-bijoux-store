...
export default function AProposPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        <Reveal>
          <p className="text-[#24BBD0]/60 text-xs tracking-[0.35em] uppercase mb-5">
            Notre histoire
          </p>
          <h1
            className="text-4xl sm:text-6xl font-light mb-6 text-[#24BBD0]"
          ...
          <p className="text-[#24BBD0]/70 max-w-xl mx-auto leading-relaxed italic">
      ...
      <div className="max-w-2xl mx-auto px-4 py-20 sm:py-24">
        ...
        <Reveal>
          <p className="text-gray-700 leading-loose mb-6 text-lg">
            Je m'appelle <strong className="text-[#24BBD0]">Marine</strong>, j'ai 21 ans,
        ...
        <Reveal delay={0.1}>
          <div className="my-12 rounded-3xl bg-gradient-to-br from-[#FAF5EA] to-[#F2E5CC] overflow-hidden">
            ...
            <div className="p-8 sm:p-10 text-center">
              ...
              <p
                className="text-2xl sm:text-3xl text-[#24BBD0] font-light italic leading-snug mb-4"
                style={{ fontFamily: 'var(--font-playfair)' }}
              >
                « la douceur de l'été »
              </p>
        ...
        <Reveal delay={0.1}>
          <p className="text-gray-600 leading-loose mb-6">
            À travers ma sélection de bijoux en <strong className="text-[#24BBD0]">acier
        ...
        <div className="max-w-5xl mx-auto">
            ...
            {[
              ...
              <Reveal key={v.title} delay={i * 0.1}>
                <div className="text-center p-8 bg-white rounded-2xl h-full">
                  ...
                  <h3
                    className="font-semibold text-[#24BBD0] mb-2"
                    style={{ fontFamily: 'var(--font-playfair)' }}
                  >
                    {v.title}
                  </h3>
          ...
          <Reveal delay={0.2} className="text-center mt-12">
            <Link
              ...
              className="inline-flex items-center gap-2 bg-[#24BBD0] hover:bg-[#D4AF37] text-white transition-colors duration-300 px-8 py-3.5 rounded-full font-medium group"
            >
