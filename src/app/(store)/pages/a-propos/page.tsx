        ...
        <div className="max-w-5xl mx-auto">
          ...
          <Reveal delay={0.2} className="text-center mt-12">
            <Link
              ...
              className="inline-flex items-center gap-2 bg-[#0E4F5E] hover:bg-[#D4AF37] text-white transition-colors duration-300 px-8 py-3.5 rounded-full font-medium group"
            >
