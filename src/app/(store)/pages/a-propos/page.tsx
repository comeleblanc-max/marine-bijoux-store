...
export default function AProposPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        <Reveal>
          <p className="text-[#0E4F5E]/60 text-xs tracking-[0.35em] uppercase mb-5">
            Notre histoire
          </p>
          <h1
            className="text-4xl sm:text-6xl font-light mb-6 text-[#0E4F5E]"
          ...
          <p className="text-[#0E4F5E]/70 max-w-xl mx-auto leading-relaxed italic">
      ...
      <div className="max-w-2xl mx-auto px-4 py-20 sm:py-24">
        ...
        <Reveal delay={0.1}>
          <div className="my-12 rounded-3xl bg-gradient-to-br from-[#FAF5EA] to-[#F2E5CC] overflow-hidden">
            ...
            <div className="p-8 sm:p-10 text-center">
              ...
              <p
                className="text-2xl sm:text-3xl text-[#0E4F5E] font-light italic leading-snug mb-4"
                style={{ fontFamily: 'var(--font-playfair)' }}
              >
                « la douceur de l'été »
              </p>
        ...
        <Reveal delay={0.1}>
          <p className="text-gray-600 leading-loose mb-6">
            À travers ma sélection de bijoux en <strong className="text-[#0E4F5E]">acier
            ...
            {[
              ...
              <Reveal key={v.title} delay={i * 0.1}>
                <div className="text-center p-8 bg-white rounded-2xl h-full">
                  ...
                  <h3
                    className="font-semibold text-[#0E4F5E] mb-2"
                    style={{ fontFamily: 'var(--font-playfair)' }}
                  >
                    {v.title}
                  </h3>
