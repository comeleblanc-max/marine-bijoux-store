  ...
  return (
    <div className="min-h-screen bg-[#FAF5EA] py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <Link href="/account" className="text-xs text-gray-500 hover:text-[#0E4F5E] transition-colors">
            ← Retour à mon compte
          </Link>
          <h1
            className="text-3xl sm:text-4xl text-[#0E4F5E] font-light mt-3"
                ...
                <div key={o.id} className="bg-white rounded-2xl p-6 hover:shadow-md transition-shadow">
                  <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
                    <div>
                      ...
                      <p className="font-mono font-semibold text-[#0E4F5E]">#{o.id.slice(-8).toUpperCase()}</p>
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-lg font-semibold text-[#0E4F5E] mt-2">{Number(o.total).toFixed(2)} €</p>
                    </div>
                  </div>
                  ...
                  {o.trackingNumber && (
                    <div className="mt-4 pt-4 border-t border-gray-100">
                      ...
                      <p className="font-mono text-sm text-[#0E4F5E]">{o.trackingNumber}</p>
                      {o.trackingCarrier && (
                        <p className="text-xs text-gray-400 mt-1">
...
function TrackingLink({ carrier, number }: { carrier: string | null; number: string }) {
  ...
  return (
    <a
      ...
      className="inline-flex items-center gap-1 mt-2 text-xs text-[#0E4F5E] hover:text-[#24BBD0] underline"
    >
