      ...
      <div className="container-x">
        <div className="flex items-end justify-between mb-10 sm:mb-14">
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl text-[#1A1A1A]">Liste de souhaits</h1>
            {products.length > 0 && (
          ...
          {products.length > 0 && (
            <button
              onClick={clear}
              className="hidden sm:flex items-center gap-2 text-[10px] tracking-[0.2em] uppercase text-[#6B6B6B] hover:text-[#1A1A1A] transition-colors"
            >
        ...
        {products.length === 0 ? (
          <div className="text-center py-16 max-w-md mx-auto">
            ...
            <p className="text-[#1A1A1A] mb-2">Aucun favori pour le moment</p>
