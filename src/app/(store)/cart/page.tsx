    ...
    return (
      <section className="min-h-[60vh] bg-white flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-3xl text-[#1A1A1A] mb-4">Votre panier est vide</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            {items.map((item) => (
              <div key={item.id} className="flex gap-4 sm:gap-5 border border-[#E8E2D5] p-4 sm:p-5 hover:border-[#C9A45F] transition-colors">
                ...
                <div className="flex-1 min-w-0 flex flex-col">
                  ...
                  <p className="text-sm text-[#1A1A1A] font-medium mt-1">{formatPrice(item.price)}</p>
          ...
          <aside className="border border-[#E8E2D5] p-6 h-fit lg:sticky lg:top-32 space-y-5">
            ...
            <div className="border-t border-[#E8E2D5] pt-4 flex justify-between items-baseline">
              <span className="text-[11px] tracking-[0.25em] uppercase font-medium text-[#1A1A1A]">Total</span>
              <span className="text-xl text-[#1A1A1A] font-medium">
