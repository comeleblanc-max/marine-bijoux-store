  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button className="flex items-center gap-2 bg-[#1A3A52] text-white px-4 py-2.5 rounded-xl text-sm font-medium hover:bg-[#1A3A52]/90 transition-colors">
          ...
          <tbody className="divide-y divide-gray-50">
            {PRODUCTS.map(product => (
              <tr key={product.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-6 py-4">
                  <span className="text-sm font-semibold text-[#1A3A52]">{formatPrice(product.price)}</span>
                  {product.compareAt && (
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center gap-2 justify-end">
                    <button className="p-1.5 rounded-lg hover:bg-gray-100 text-gray-400 hover:text-[#1A3A52] transition-colors">
