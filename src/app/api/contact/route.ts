...
export async function POST(req: Request) {
  try {
    ...
    const html = `
      <div style="font-family: -apple-system, Helvetica, Arial, sans-serif; max-width:600px; margin:auto; color:#1F3A56;">
        <div style="background:#1F3A56; color:white; padding:24px; text-align:center;">
